...
exports.statsCommand = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .setRequired(false)
        .addChoices({ name: 'Win Rate', value: 'winrate' }, { name: 'Total Wins', value: 'wins' }, { name: 'Tournaments Played', value: 'tournaments' }, { name: 'Championships', value: 'championships' })))
        .addSubcommand(subcommand => subcommand
        .setName('matchup')
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'player') {
            ...
            const leaderboardText = top10.map((player, index) => {
